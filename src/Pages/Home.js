...
const Home = () => {
    return (
        ...
        <div>
            ...
            <div className="bg-yellow-50  relative lg:h-screen px-4 pt-10 lg:pt-20 lg:pb-20 mx-auto lg:py-32 md:px-8 xl:px-20 sm:max-w-xl md:max-w-full">
                <div className="max-w-xl mx-auto pb-20 h-100 lg:max-w-screen-xl">
                    <div className="p-0 lg:max-w-lg lg:mb-0">
                        <div className="mt-44  lg:pt-40 justify-center align-middle max-w-xl mb-6">
                            <h1 className='lg:text-5xl text-3xl font-bold mb-4'>Education Is About Academic Excellence</h1>
                ...
                <div className="flex justify-center m-0 lg:mt-40 z-0  lg:w-2/3 xl:w-1/2 lg:absolute lg:justify-start lg:bottom-0 lg:right-0 lg:items-end">
                    <img
                        className='lg:w-2/3 w-2/3  lg:h-2/4'
