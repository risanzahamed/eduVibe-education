...
const Login = () => {
    ...
    return (
        <div class="flex align-middle justify-center mt-32 mb-32 w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div class="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                        ...
                        <div class="flex items-center mt-6 -mx-2">
                            ...
                            <Link to="#" class="p-2 mx-2 text-sm font-medium text-gray-500 transition-colors duration-300 transform bg-gray-300 rounded-md hover:bg-gray-200">
