                ...
                <div className="container p-6 mx-auto">
                    <div className="lg:flex">
                        <div className="w-full -mx-6 lg:w-2/5">
                            <div className="px-6">
                                <div>
                                    <Link to="#" className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Brand</Link>
                                </div>
                    ...
                    <hr className="h-px my-6 bg-gray-200 border-none dark:bg-gray-700" />
                        ...
                        <div>
                            <p className="text-center text-gray-500 dark:text-gray-400">© EduVibe 2020 - All rights reserved</p>
                        </div>
                </div>
            </footer>
